        ...
        AslSlideContent(
            ...
            when (step) {
                ...
                1 -> ConfigureStep(
                    ...
                    buildDsl = uiState.buildDsl,
                    useCpp = uiState.useCpp,
                    ...
                    onTargetSdkChanged = { interactionListener.onTargetSdkChanged(it) },
                    onLanguageChanged = { interactionListener.onLanguageChanged(it) },
                    onBuildDslChanged = { interactionListener.onBuildDslChanged(it) },
                    onToggleCpp = { interactionListener.onToggleCpp(it) },
                    onBrowseLocation = onBrowseLocation,
                )
