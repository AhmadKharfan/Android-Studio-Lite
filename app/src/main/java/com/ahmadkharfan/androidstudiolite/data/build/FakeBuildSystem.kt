...
class FakeBuildSystem(
        ...
        return ProjectModel(
            ...
            modules = listOf(
                ModuleModel(
                    ...
                    dependencies = listOf(
                        com.ahmadkharfan.androidstudiolite.domain.buildsystem.DependencyModel(
    ...
    override fun build(request: BuildRequest): Flow<BuildEvent> {
        ...
        return flow {
            ...
            if (fail) {
                emitFailingScript(request, artifact = artifact)
    ...
    private suspend fun kotlinx.coroutines.flow.FlowCollector<BuildEvent>.emitSucceedingScript(
    ...
    private suspend fun kotlinx.coroutines.flow.FlowCollector<BuildEvent>.emitFailingScript(
        request: BuildRequest,
        artifact: File,
    ) {
        val module = request.modulePath.ifBlank { ":app" }
