...
dependencies {
    ...
    implementation(projects.feature.terminal.presentation)
    implementation(projects.feature.buildrun.presentation)
    implementation(projects.feature.buildrun.api)
    implementation(projects.feature.git.presentation)
